...
namespace ToolTest
{
...

    {
        ...
        void LoadData()
        {
            ...
            PHONE = (Bitmap)Bitmap.FromFile("E://data//facebookreg//phone.png");
            NEXT = (Bitmap)Bitmap.FromFile("E://data//facebookreg//next.png");
            LOGINCODE = (Bitmap)Bitmap.FromFile("E://data//facebookreg//logincode.png");
            SEND = (Bitmap)Bitmap.FromFile("E://data//facebookreg//send.png");
            CODE = (Bitmap)Bitmap.FromFile("E://data//facebookreg//code.png");
        ...
        public string BigoReg(String deviceID, String username,String simID)
        {
            ...
            {
                Delay(1);
                if (Services.findImage(deviceID, LOGINCODE) == true)
                {
                    Delay(1);
                    break;
                }
            ...
            {
                Delay(1);
                if (Services.findImage(deviceID, SEND) == true)
                {
                    Delay(1);
                    break;
                }
