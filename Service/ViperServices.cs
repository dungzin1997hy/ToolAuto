...
namespace ToolTest
{
    class ViperServices
    {
        ...
        public void run3(String deviceID, String username, String password, String simID, String phoneNumber, String noxID)
        {
            ...
            String result1 = skype.chooseViper(deviceID, noxID);
            ...
            result1 = skype.login(deviceID, username, noxID);
            ...
            else if (result1.Equals("Wrong Username"))
            {
                ...
                print("Login Viper", process, result1);
