...
namespace ToolTest
{
...

    {
        ...
        public void run3(String deviceID, String username, String password, String simID, String phoneNumber, String noxID)
        {
            ...
            String result1 = skype.chooseUber(deviceID, noxID);
            if (result1.Equals("Open Uber Success"))
            {
                process = 10;
                print("Open Uber", process, "");

            }
            else if (result1.Equals("Open App Error"))
            {

                print("Open Uber", process, result1);
                skype.Exit(deviceID);
                Environment.Exit(0);
            }
            ...
            {
                process = 50;
                print("Login Uber Success", process, "");

            }
            else if (result1.Equals("Wrong Username"))
            {

                print("Login Uber", process, result1);
