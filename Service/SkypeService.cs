...
namespace ToolTest
{
    class SkypeService
    {
        ...
        public void run3(String deviceID, String username, String password,String simID,String phoneNumber, String noxID)
        {
            ...
            if (result1.Equals("Open Skype Success"))
            {
                process = 10;
                print("Open Skype", process, "");

            }
            else if (result1.Equals("Open App Error"))
            {

                print("Open Skype", process, result1);
                skype.Exit(deviceID);
                Environment.Exit(0);
            }
            ...
            {
                process = 50;
                print("Login Skype Success", process, "");

            }
            else if (result1.Equals("Wrong Username"))
            {

                print("Login Skype", process, result1);
            ...
            else if (result1.Equals("Need Code"))
            {
                ...
                String result = skype.inputCode(deviceID,phoneNumber, simID);
