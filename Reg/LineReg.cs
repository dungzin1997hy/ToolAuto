...
namespace ToolTest
{
...

    {
        ...
        void LoadData()
        {
            ...
            SIGNUP = (Bitmap)Bitmap.FromFile("C://data//lineReg//signup.png");
            ...
            CREATEACCOUNT = (Bitmap)Bitmap.FromFile("C://data//line//createaccount.png");
            NAME = (Bitmap)Bitmap.FromFile("C://data//line//name.png");
            INPUTPASSWORD = (Bitmap)Bitmap.FromFile("C://data//line//inputpassword.png");
            YESACCOUNTREG = (Bitmap)Bitmap.FromFile("C://data//line//yesaccountreg.png");
        ...
        public string login(String deviceID, String username, String password, String noxID,String phonenumber)
        {
            while (true)
            {
                Delay(1);
            ...
            while (true)
            {
                ...
                if (wrongusernamePoint != null)
                {
                    ...
                    while (true)
                    {
                        Delay(1);
                        var screen1 = Services.ScreenShoot(deviceID);
                        var phoneNumberPoint = KAutoHelper.ImageScanOpenCV.FindOutPoint(screen1, PHONENUMBER);
                        if (phoneNumberPoint == null)
                        {
                            KAutoHelper.ADBHelper.Key(deviceID, KAutoHelper.ADBKeyEvent.KEYCODE_DEL);
        ...
        public String inputCode(String deviceID, String simID,String firstname, String lastname,String password)
        {
            int dem = 80;
            String code = "";
            while (true)
            ...
            while (true)
            {
                ...
                var yesaccountPoint = KAutoHelper.ImageScanOpenCV.FindOutPoint(screen, YESACCOUNTREG);
                var accountPoint = KAutoHelper.ImageScanOpenCV.FindOutPoint(screen, YESACCOUNT);
                ...
                if (wrongcodePoint != null)
                {
                    ...
                    while (true)
                    {
                        ...
                        if (yesaccountPoint1 != null)
                        {
                            ...
                            {
                                Delay(1);
                                if (Services.findImage(deviceID, INPUTPASSWORD) == true)
                                {
                                    break;
                                }
                            }
                            KAutoHelper.ADBHelper.Tap(deviceID, 150, 330);
                            Delay(1);
                            KAutoHelper.ADBHelper.InputText(deviceID, password);
                            Delay(1);
                            KAutoHelper.ADBHelper.Tap(deviceID, 150, 430);
                            Delay(1);
                            KAutoHelper.ADBHelper.InputText(deviceID, password);
                            Delay(1);
                            while (true)
